...
class EdgeMatrices:
    def __init__(self, use_compression: bool = False):
        ...
        self._typed: dict[str, csr_matrix | CompressedEdgeMatrix] = {}
        self._combined_all: csr_matrix | CompressedEdgeMatrix | None = None
        self._cache: dict[frozenset, csr_matrix | CompressedEdgeMatrix] = {}
        self._edge_data: dict[str, list[dict]] = {}
        self._transpose_cache: dict[str, csr_matrix | CompressedEdgeMatrix] = {}
        self._combined_transpose: csr_matrix | CompressedEdgeMatrix | None = None
